...
# → dist/llmperf-1.2.0.tar.gz                 (Linux / Docker)

./scripts/package-docker-mac.sh 1.2.0
# → dist/llmperf-docker-mac-arm64-1.2.0.tar.gz (Mac Docker Desktop)

./scripts/package-mac.sh 1.2.0
# → dist/llmperf-mac-arm64-1.2.0.tar.gz        (Mac native Python)
```
